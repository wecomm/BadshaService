            ...
            <div class="box-body">
              <div class="col-lg-offset-3 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="title" name="title" value="{{$company->title}}" placeholder="Company Name">
                </div>

                <div class="form-group">
                  <label for="icon">ICON</label>
                  <input type="text" class="form-control" name="icon" value="{{ $company->icon }}" id="icon">
                </div>
